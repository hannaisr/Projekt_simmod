...
class Brownian(Freely_jointed_chain):
    """3D chain generated by Brownian motion in each spatial direction"""
    # # Alternative:
    # def walk_one_step(self, limited=False):
    #     self.r = rnd.normalvariate(1,1) # Normal variation of step length with expected value = 1
...
def main():
    ...
    grid_walker_stepl_variations.walk_with_self_avoid(nsteps=10)
